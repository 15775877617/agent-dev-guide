...
![hermes gateway setup](images/hermes gateway setup.png)
...
![QQ扫码标注](images/QQ扫码标注.png)

---

#### Step 3：点击QQ扫码链接

点击红线标注链接跳转网页，用QQ进行扫码

![QQ扫码标注](images/QQ扫码标注.png)

![QQ网页二维码](images/QQ网页二维码.png)
...
<img src="images/QQ实际效果.jpg" alt="QQ实际效果" style="zoom: 25%;" />
...
![微信选择二维码](images/微信选择二维码.png)

![选择扫码](images/选择扫码.png)
...
> **📷 截图位置**：终端显示平台选择列表，Feishu / Lark 被高亮选中的画面
...
> **📷 截图位置①**：终端显示二维码的画面
> **📷 截图位置②**：【需要你补充：手动输入模式的 App ID/Secret 输入界面截图】
